...
export class EngagedState {
    ...
    _processMessageYouTubeVideoData(msg, messageTimeStamp) {
        ...
        if (jsonMessageData.widgetType === "youtube-video") {
            ...
            const iframeVideo =  `<p>${msg.messageText}</p><span class="govuk-visually-hidden">embedded youtube video below with url</span><div class="iframe-wrap"><iframe title="Embedded YouTube Video" class="video-message" frameborder="0" allowFullScreen="true" webkitallowfullscreen="true" mozallowfullscreen="true" src="${embeddedVideoUrl}"></iframe></div>`;
