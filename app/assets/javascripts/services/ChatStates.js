...
export class EngagedState {
    ...
    _processMessageYouTubeVideoData(msg, messageTimeStamp) {
        ...
        if (jsonMessageData.widgetType === "youtube-video") {
            ...
            const iframeVideo =  `<p>${msg.messageText}</p><p><a href="${youtubeURL}"> ${youtubeURL}</a></p><div class="iframe-wrap"><iframe class="video-message" frameborder="0" allowFullScreen="true" webkitallowfullscreen="true" mozallowfullscreen="true" src="${embeddedVideoUrl}"></iframe></div>`;
