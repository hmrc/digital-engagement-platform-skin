...
export default class ClickToChatButtons {
    ...
    _updateButton(c2cObj, button, hmrcSkin) {
        ...
        if (hmrcSkin) {
            innerHTML = `<div id="ciapiSkinMinimised"><button id="ciapiSkinRestoreButton" type="button" draggable="false" role="button" tabindex="0"><div id="logo-white"><img src="/engagement-platform-skin/assets/media/logo-white.png"></div><h2 class="${button.buttonClass} ${c2cObj.displayState}">${buttonText}</h2></button></div>`
        } else {
