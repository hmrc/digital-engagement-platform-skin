...
```
http://localhost:9956/ask-hmrc/chat/ask-hmrc-online
```

localhost 9956 is digital-engagement-platform-frontend that pulls in the chatskin.
You may want to test the chatskin on your own service. 
