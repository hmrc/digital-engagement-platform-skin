...
describe("CommonChatController", () => {
  ...
  it("include elements for printing using onPrint", () => {
    ...
    <div role="form" id="ciapiSkinFooter" class="govuk-!-display-none-print">
      ...
      <div id="ciapiSend">
        <button id="ciapiSkinSendButton" class="govuk-button" data-module="govuk-button" disabled="">Send message</button>
    ...
    expect(htmlElements[0].outerHTML).toBe(`<div class="timestamp-outer"><p class="print-only govuk-body popup-print-float-left" aria-hidden="true">1:40 PM</p></div>`)
    expect(htmlElements[3].outerHTML).toBe(`<div class="timestamp-outer"><p class="print-only govuk-body popup-print-float-right print-timestamp-right" aria-hidden="true">1:55 PM</p></div>`)
    expect(htmlElements[4].outerHTML).toBe(`<div class="timestamp-outer"><p class="print-only govuk-body popup-print-float-left" aria-hidden="true">1:55 PM</p></div>`)
