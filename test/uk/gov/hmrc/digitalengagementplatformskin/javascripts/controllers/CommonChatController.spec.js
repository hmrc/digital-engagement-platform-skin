...
it("catches an exception in the showChat function", () => {
  ...
  it("onPrint should remove elements on popup", () => {
      ...
      expect(document.querySelector("div.govuk-width-container").classList.contains("govuk-!-display-none-print")).toBe(false);
      ...
      expect(document.querySelector("div.govuk-width-container").classList.contains("govuk-!-display-none-print")).toBe(true);
