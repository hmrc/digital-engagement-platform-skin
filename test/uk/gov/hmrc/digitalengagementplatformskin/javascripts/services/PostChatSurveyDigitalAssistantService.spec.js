...
const survey = {
    ...
    answers: [
        ...
        { id: "a3", text: "Social media", freeform: false }
    ]
};
    ...
    it("sends event for beginning a post chat survey", () => {
        ...
        const expectedContentSentToCustomerEvent = {
            ...
            "custom.decisiontree.questions":
                ...
                "If%2520you%2520had%2520not%2520used%2520the%2520chatbot%2520today%252C%2520how%2520else%2520would%2520you%2520have%2520contacted%2520us%253F",
    ...
    it("sends event for submitting a post chat survey", () => {
        ...
        const expectedCustomerRespondedEvent = {
            ...
            "custom.decisiontree.questions":
                ...
                "How%2520could%2520we%2520improve%2520it%253F%2C" +
                "If%2520you%2520had%2520not%2520used%2520the%2520chatbot%2520today%252C%2520how%2520else%2520would%2520you%2520have%2520contacted%2520us%253F",
            "custom.decisiontree.answers": "Yes%2Ctext%252520area%252520text%2CSocial%252520media",
            "custom.decisiontree.answerIDs": "Yes%2Ctext%2520area%2520text%2CSocial%2520media",
