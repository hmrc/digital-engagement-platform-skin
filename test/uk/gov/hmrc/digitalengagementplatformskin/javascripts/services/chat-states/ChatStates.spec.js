  ...
  afterEach(() => {
    ...
    describe("EngagedState", () => {
        ...
        it("calls the transcript QuickReply YouTube Video method", () => {
            ...
            expect(firstArgToTranscriptAddAutomatonMsg).toBe(`<p>Video test message</p><p><a href=\"https://www.youtube.com/watch?v=Jn46jDuKbn8\" target=\"_blank\"> https://www.youtube.com/watch?v=Jn46jDuKbn8</a> (opens in new tab)</p><div class="iframe-wrap"><iframe class="video-message" frameborder="0" allowFullScreen="true" webkitallowfullscreen="true" mozallowfullscreen="true" src="https://www.youtube.com/embed/Jn46jDuKbn8"></iframe></div>`);
        });
    });
