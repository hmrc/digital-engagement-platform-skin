  ...
  afterEach(() => {
    ...
    describe("EngagedState", () => {
        ...
        it("calls the transcript QuickReply YouTube Video method", () => {
            ...
            expect(firstArgToTranscriptAddAutomatonMsg).toBe(`<p>Video test message</p><span class=\"govuk-visually-hidden\">embedded youtube video below with url</span><div class="iframe-wrap"><iframe title=\"Embedded YouTube Video\" class="video-message" frameborder="0" allowFullScreen="true" webkitallowfullscreen="true" mozallowfullscreen="true" src="https://www.youtube.com/embed/Jn46jDuKbn8"></iframe></div>`);
        });
    });
