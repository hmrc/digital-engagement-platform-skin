...
const surveyWithOption = {
    ...
    questions: [
        ...
        { id: "q4", text: "Why did you give this answer?", freeform: true },
    ...
    it("sends event for beginning a post chat survey", () => {
        ...
        const expectedContentSentToCustomerEvent = {
            ...
            "custom.decisiontree.questions":
                "Were%2520you%2520able%2520to%2520do%2520what%2520you%2520needed%2520to%2520do%2520today%253F%2CHow%2520easy%2520was%2520it%2520for%2520you%2520to%2520do%2520what%2520you%2520needed%2520to%2520do%2520today%253F%2COverall%252C%2520how%2520did%2520you%2520feel%2520about%2520the%2520service%2520you%2520received%2520today%253F%2CWhy%2520did%2520you%2520give%2520this%2520answer%253F%2CIf%2520you%2520had%2520not%2520used%2520Webchat%2520today%252C%2520how%2520else%2520would%2520you%2520have%2520contacted%2520us%253F%2CSelect%2520how%2520you%2520prefer%2520to%2520contact%2520HMRC",
