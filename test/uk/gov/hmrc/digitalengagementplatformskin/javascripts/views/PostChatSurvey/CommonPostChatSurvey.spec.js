...
describe("CommonPostChatSurvey", () => {
    ...
    test('Click on print prints post chat survey', () => {
        jest.spyOn(commonPostChatSurvey, 'onPrintOrSavePostChatSurvey').mockImplementation();

        commonPostChatSurvey.attachTo(container);
        var event = new KeyboardEvent('click', {});
        if (commonPostChatSurvey.wrapper.querySelector("#printOrSavePostChat")) {
            commonPostChatSurvey.wrapper.querySelector("#printOrSavePostChat").dispatchEvent(event);
            expect(commonPostChatSurvey.onPrintOrSavePostChatSurvey).toHaveBeenCalled();
        }
    });
    ...
    test('onPrintOrSavePostChatSurvey shows transcript without the post chat survey', () => {
        ...
        commonPostChatSurvey.onPrintOrSavePostChatSurvey(evt);
